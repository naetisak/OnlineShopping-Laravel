                            ...
                            @foreach ($data as $item)
                                <tr>
                                    ...
                                    <td class="flex px-4 py-3 justify-center text-lg">
                                        <button onclick="editColor('{{$item->id}}','{{$item->name}}','{{$item->code}}','{{$item->is_active}}')"
            ...
            <form action="{{route('dpanel.color.store')}}" method="post">
                ...
                <div class="grid grid-cols-1 gap-3">
                    ...
                    <div class="text-center">
                        <button class="bg-indigo-500 text-center text-white py-1 px-2 rounded shadow-md uppercase">Add
                            New
                            Color</button>
                    </div>
