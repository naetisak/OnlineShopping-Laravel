            ...
            <section id="profile" class="tabContent border border-slate-300 rounded px-4 pt-2 pb-4">
                ...
                <form action="{{ route('address.update', $data->id) }}" method="POST" 
                    ...
                    <div class="mt-4 relative border border-slate-300 rounded">
                        ...
                        <input type="text" name="first_name" value="{{$data->first_name}}" class="mt-2 px-3 bg-transparent focus:outline-none w-full" required>
                    </div>

                    <div class="mt-4 relative border border-slate-300 rounded">
                        <label for="" class="absolute -top-3.5 left-3 bg-gray-50 px-1 text-gray-400">Last Name</label>
                        <input type="text" name="last_name" value="{{$data->last_name}}" class="mt-2 px-3 bg-transparent focus:outline-none w-full" required>
                    </div>

                    <div class="mt-4 relative border border-slate-300 rounded">
                        <label for="" class="absolute -top-3.5 left-3 bg-gray-50 px-1 text-gray-400">Mobile Number</label>
                        <input type="tel" maxlength="10" name="mobile_no" value="{{$data->mobile_no}}" class="mt-2 px-3 bg-transparent focus:outline-none w-full" required>
                    </div>
                    ...
                    <div class="mt-4 relative border border-slate-300 rounded">
                        ...
                        <input type="tel" onkeyup="getDistrictStateByPinCode(this)" value="{{$data->pin_code}}" maxlength="6" name="pin_code" 
                        class="mt-2 px-3 bg-transparent focus:outline-none w-full">
                    </div>
