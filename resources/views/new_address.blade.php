    ...
    <div class="px-6 md:min-h-screen md:px-20 mt-6 grid grid-cols-1 md:grid-cols-6 gap-4">
        <div>
            <ul class="flex md:flex-col flex-wrap justify-between gap-3 md:gap-1" id="tabLinks">
                <li><a class="flex" href="{{route('account.index')}}"></a>My Profile</li>
                <li><a class="flex" href="{{route('account.index' ,['tab' => 'orders'])}}"></a>My Order</li>
                <li><a class="flex text-violet-600 underline" href="{{route('account.index' ,['tab' => 'address'])}}"></a>My Address</li>
        ...
        <div class="md:col-span-5">
            <section id="profile" class="tabContent border border-slate-300 rounded px-4 pt-2 pb-4">
                ...
                <form action="{{ route('address.store') }}" method="POST" class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div class="mt-4 relative border border-slate-300 rounded">
                        <label for="" class="absolute -top-3.5 left-3 bg-gray-50 px-1 text-gray-400">Default Address Type</label>
                        <select name="tag" class="mt-2 px-3 bg-transparent focus:outline-none max-w-full" required>
                            <option value="">select</option>
                    ...
                    <div class="mt-4 relative border border-slate-300 rounded">
                        ...
                        <input type="text" name="first_name" class="mt-2 px-3 bg-transparent focus:outline-none w-full" required>
                    </div>

                    <div class="mt-4 relative border border-slate-300 rounded">
                        <label for="" class="absolute -top-3.5 left-3 bg-gray-50 px-1 text-gray-400">Last Name</label>
                        <input type="text" name="last_name" class="mt-2 px-3 bg-transparent focus:outline-none w-full" required>
                    </div>

                    <div class="mt-4 relative border border-slate-300 rounded">
                        <label for="" class="absolute -top-3.5 left-3 bg-gray-50 px-1 text-gray-400">Mobile Number</label>
                        <input type="tel" maxlength="10" name="mobile_no" class="mt-2 px-3 bg-transparent focus:outline-none w-full" required>
                    </div>
                    ...
                    <div class="mt-4 relative border border-slate-300 rounded">
                        <label for="" class="absolute -top-3.5 left-3 bg-gray-50 px-1 text-gray-400">Pin Code</label>
                    ...
                    <div class="mt-4 relative border border-slate-300 rounded">
                        ...
                        <select name="district" id="district" class="mt-2 px-3 bg-transparent focus:outline-none w-full"required >
                        </select>
                    </div>

                    <div class="mt-4 relative border border-slate-300 rounded">
                        <label for="" class="absolute -top-3.5 left-3 bg-gray-50 px-1 text-gray-400">State</label>
                        <select name="state" id="state" class="mt-2 px-3 bg-transparent focus:outline-none w-full"required >
                        </select>
                    </div>

                    <div>
                        <label for="">&nbsp;</label>
                        <button class="bg-violet-500 rounded shadow-lg py-1 text-center w-full text-white uppercase font-medium">Save</button>
                    </div>
